    ...
    <>
      ...
      <div className="teacher-toolbar shrink-0 overflow-x-auto scrollbar-hide">
            ...
            {eraserMode !== 'off' && (
              <>
                <button
                  ...
                  aria-label="Click on a stroke to delete the whole stroke"
                  style={{ fontSize: 12 }}
                >
                  Stroke
                </button>
                <button
                  ...
                  aria-label="Drag to erase pixels (precise eraser)"
                  style={{ fontSize: 12 }}
                >
                  Pixel
                </button>
        ...
        <button onClick={onToggleScrollSync}
          ...
          aria-label={scrollSyncEnabled ? 'Scroll linked — click to unlink' : 'Scroll free — click to link'}>
        ...
        <button onClick={onToggleStudentInteraction}
          ...
          aria-label={studentInteractionAllowed ? 'Students can interact — click for view-only' : 'View-only mode — click to allow interaction'}>
        ...
        <div className="relative" style={{ display: 'inline-flex' }}>
          <button onClick={() => setShowTimerMenu(!showTimerMenu)}
            ...
            aria-label={challengeTimer ? `${challengeTimer.remaining}s remaining` : 'Challenge timer'}>
            {challengeTimer ? (
        ...
        <button
          ...
          aria-label={whiteboardMode ? 'Back to simulation' : 'Open the shared whiteboard'}
        ...
        {!whiteboardMode && (
          <button
            ...
            aria-label={explanationActive ? `Showing: ${explanationName || 'explanation'} — click to exit` : 'Upload an explanation HTML to overlay'}
        ...
        <button
          ...
          aria-label={followStudentClicks ? 'Stop following student clicks' : 'Follow student clicks'}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
