  ...
  return (
    <>
      ...
      <div className="teacher-toolbar shrink-0 overflow-x-auto scrollbar-hide">
        ...
        <button onClick={onZoomOut} className="tb-btn" data-tip={zoomLevel <= 0.5 ? "Minimum zoom level reached" : "Zoom out (synced)"} disabled={zoomLevel <= 0.5}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button onClick={onZoomIn} className="tb-btn" data-tip={zoomLevel >= 3 ? "Maximum zoom level reached" : "Zoom in (synced)"} disabled={zoomLevel >= 3}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
