    ...
    <>
      ...
      <div className="teacher-toolbar shrink-0 overflow-x-auto scrollbar-hide">
        ...
        <button onClick={() => { onSetDrawMode(false); onSetLaserMode(false); }}
          className={`tb-btn ${isCursor ? 'active' : ''}`} aria-label="Cursor" data-tip="Cursor">
        ...
        <button onClick={() => { onSetDrawMode(true); onSetPenType('transient'); onSetLaserMode(false); }}
          className={`tb-btn ${isDraw ? 'active' : ''}`} aria-label="Draw (fades)" data-tip="Draw (fades)">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button onClick={() => { onSetDrawMode(true); onSetPenType('permanent'); onSetLaserMode(false); }}
          className={`tb-btn ${isInk ? 'active' : ''}`} aria-label="Ink (permanent)" data-tip="Ink (permanent)">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button onClick={onToggleWhiteboard} className={`tb-btn ${whiteboardMode ? 'active-indigo' : ''}`} aria-label={whiteboardMode ? 'Exit whiteboard' : 'Open whiteboard'} data-tip={whiteboardMode ? 'Exit whiteboard' : 'Open whiteboard'}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
