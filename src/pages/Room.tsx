    ...
    <div className="h-screen flex flex-col overflow-hidden"
      ...
      <header className="app-header">
        ...
        <div className="header-section">
          ...
          <button onClick={() => setShowLibrary(true)} className="btn-icon hidden sm:inline-flex" data-tip="Library" aria-label="Open simulation library">
          ...
          <button onClick={toggleRecording}
            ...
            data-tip={isRecording ? 'Stop Recording' : 'Record'} aria-label={isRecording ? 'Stop screen recording' : 'Start screen recording'}>
            {isRecording ? (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="none" aria-hidden="true"><rect x="6" y="6" width="12" height="12" rx="2"/></svg>
            ) : (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="6"/></svg>
            )}
          </button>
          ...
          <button onClick={() => { const m = sounds.toggleMute(); setSoundMuted(m); }}
            className="btn-icon" data-tip={soundMuted ? 'Unmute' : 'Mute'} aria-label={soundMuted ? 'Unmute sound' : 'Mute sound'}>
            {soundMuted ? (
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
