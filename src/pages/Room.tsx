    ...
    <div className="h-screen flex flex-col overflow-hidden"
      ...
      <header className="app-header">
        ...
        <div className="header-section">
          ...
          <button onClick={() => setShowLibrary(true)} aria-label="Library" className="btn-icon hidden sm:inline-flex" data-tip="Library">
          ...
          <button onClick={toggleRecording}
            aria-label="Toggle Recording" className={`btn-icon hidden sm:inline-flex ${isRecording ? 'active-rose' : ''}`}
