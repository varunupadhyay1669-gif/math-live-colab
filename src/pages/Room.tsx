    ...
    <div className="h-screen flex flex-col overflow-hidden"
      ...
      <header className="app-header">
          ...
          <div style={{ display: 'flex', gap: '2px' }}>
            {(['code', 'split', 'preview'] as ViewMode[]).map(mode => (
              <button key={mode} onClick={() => setViewMode(mode)}
                ...
                aria-label={mode.charAt(0).toUpperCase() + mode.slice(1)} data-tip={mode.charAt(0).toUpperCase() + mode.slice(1)}>
                {mode === 'code' && (
        ...
        <div className="header-section">
          ...
          <button onClick={() => setShowLibrary(true)} className="btn-icon hidden sm:inline-flex" aria-label="Library" data-tip="Library">
          ...
          <button onClick={toggleRecording}
            ...
            aria-label={isRecording ? 'Stop Recording' : 'Record'} data-tip={isRecording ? 'Stop Recording' : 'Record'}>
            {isRecording ? (
          ...
          }} className="btn-icon" aria-label="Fullscreen" data-tip="Fullscreen">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button onClick={() => { const m = sounds.toggleMute(); setSoundMuted(m); }}
            className="btn-icon" aria-label={soundMuted ? 'Unmute' : 'Mute'} data-tip={soundMuted ? 'Unmute' : 'Mute'}>
            {soundMuted ? (
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
